...
ActiveRecord::Schema.define(version: 2018_06_16_161439) do
  ...
  create_table "restaurant_managers", force: :cascade do |t|
    ...
    t.index ["restaurant_id", "manager_id"], name: "index_restaurant_managers_on_restaurant_id_and_manager_id", unique: true
